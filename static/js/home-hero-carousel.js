(()=>{
  ...
  @media(min-width:1024px){.lead-grid.has-hero-carousel{display:grid!important;grid-template-columns:minmax(0,2.05fr) minmax(310px,.72fr)!important;gap:18px!important;align-items:stretch!important}.lead-grid.has-hero-carousel>.flash-panel{display:flex!important}.hero-carousel{border-radius:2px!important}.hero-carousel .lead-story{min-height:610px!important;border-radius:2px!important}}
  `;
